    ...
    if($pagination_masonry == "load_more") { 
		if (get_next_posts_link()) { ?>
			<div class="blog_load_more_button_holder">
				<div class="blog_load_more_button"><span rel="<?php echo $wp_query->max_num_pages; ?>"><?php echo get_next_posts_link(__('MOSTRAR MAIS', 'qode')); ?></span></div>
	 ...
	 <?php } elseif($pagination_masonry == "infinite_scroll") { ?>
		<div class="blog_infinite_scroll_button"><span rel="<?php echo $wp_query->max_num_pages; ?>"><?php echo get_next_posts_link(__('MOSTRAR MAIS', 'qode')); ?></span></div>
	<?php }else { ?>
